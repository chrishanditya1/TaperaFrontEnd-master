    ...
    return (
        ...
        <Container maxWidth="xl" component="main" className={classes.root}>
            <Grid container justify="center">
                <Grid item>
                    <Card>
                        <CardHeader title="Pendaftaran Pekerja Upload" titleTypographyProps={{ align: 'center' }}>
                        </CardHeader>
                        <CardContent>
                        ...
                        <div className={classes.paper}>
                            <CardActions>
                                <Button href="/upload" variant="outlined" style={{ backgroundColor: '#008F4C', color: '#fff' }}>Upload</Button>
                            </CardActions>
                        </div>
