    ...
    if (user) {
      ...
      <AppBar position="static" color="default" elevation={0}>
        ...
        <Link href="/">
          ...
          <nav>
          <IconButton href="/login" aria-label="login" className={classes.margin}>
            <ExitToAppIcon />
            </IconButton>
            <IconButton href="#" aria-label="daftar" className={classes.margin}>
              <NoteAddIcon />
            </IconButton>
            <IconButton href="/bantuan" aria-label="informasibantuan" className={classes.margin}>
            <HelpOutlineIcon />
            </IconButton>
            <Button href='/bantuan' id='btnBantuanDanInformasi'>Bantuan & Informasi</Button>
            <ScrollLink to="daftarSection" spy={true} smooth={true} duration={500} className="MuiButtonBase-root MuiButton-root MuiButton-text" tabIndex="0" id="btnDaftar">Daftar</ScrollLink>
            <Button id='btnLogin' href='/login'>Login</Button>
          </nav>
          {/* <div>
            <IconButton
              id="iconBtnProfile"
            ...
            <Menu
              ...
              TransitionComponent={Fade}
            >
              <MenuItem onClick={handleClose}><Button className={classes.dropdownbutton} id="btnDropDownLihatProfil" >Lihat Profil</Button></MenuItem>
              <MenuItem onClick={handleClose}><Button className={classes.dropdownbutton} id="btnDropDownLogout" href='/'>Logout</Button></MenuItem>
            </Menu>
          </div> */}
        </Toolbar>
      </AppBar>
