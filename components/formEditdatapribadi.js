...
import {listStatusPernikahan, listAgama, listInfoKepemilikanRumah, listJenisInvestasi} from '../components/listISOCode';
    ...
    <div className={classes.root} noValidate autoComplete="off">
      ...
      >
        ...
        <div className={classes.tombol} style={{ width: '100%' }}>
            ...
            <Button className={classes.tombolconfig} type="submit" onClick={handleChange} fullWidth variant="contained" color="primary" >Simpan</Button>
