...
export const listISOCodeCountry = [
    {
          value: '',
          ISOCode: '',
  ...
  export const listKabupatenKota = 
  [
  ...
  export const listStatusPernikahan =
  [
    { value: '', label: 'Pilih Satus Pernikahan' },
  ...
  export const listInfoKepemilikanRumah =
  [
  ...
  export const listJenisInvestasi = [
