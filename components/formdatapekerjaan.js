      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div>
          ...
          <NumberFormat
            ...
            value={formik.values.txtGajiPokok+formik.values.txtNilaiTunjanganJabatan+formik.values.txtNilaiTunjanganKeluarga+formik.values.txtNilaiTunjanganKinerja+formik.values.txtNilaiTunjanganProfesi+formik.values.txtTunjanganLain1+formik.values.txtTunjanganLain2+formik.values.txtTunjanganLain3}
        ...
        <div>
          ...
          <TextField
            ...
            value={formik.values.txtNipLama || ''}
            onChange={formik.handleChange}
          >
          </TextField>
          <TextField
