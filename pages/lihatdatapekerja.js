...
import FormEditdatapribadi from '../components/formLihatdatapribadi';
import FormEditdataalamat from '../components/formLihatdataalamat';
import FormEditdatapekerjaan from '../components/formLihatdatapekerjaan';
import FormEditdatafinansial from '../components/formLihatdatafinansial';
    ...
    <div className={classes.root}>
      ...
      <AppBar position="static" color="default">
        <Tabs
          ...
          textColor="primary"
        >
          <Tab label="Data Kepesertaan" {...p11yProps(0)}  />
      ...
      <TabPanel value={valueP} index={1}>
        <FormEditdatapribadi handleNext={handleChange} listdata= {listdataPekerja}></FormEditdatapribadi>
      </TabPanel>
      ...
      <TabPanel value={valueP} index={4}>
        <FormEditdatafinansial handleNext={handleChange} listdata= {listdataPekerja}></FormEditdatafinansial>
      </TabPanel>
     </Layout>
    </div>
  );
