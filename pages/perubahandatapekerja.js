    ...
    <div className={classes.root}>
      ...
      <AppBar position="static" color="default">
        ...
        >
          ...
          <Tab label="Data Pribadi" {...p11yProps(1)} disabled />
          <Tab label="Data Alamat" {...p11yProps(2)} disabled />
          <Tab label="Data Pekerjaan" {...p11yProps(3)} disabled />
          <Tab label="Data Finansial" {...p11yProps(4)} disabled />
        </Tabs>
      </AppBar>
