    ...
    <div className={classes.root}>
      ...
      <AppBar position="static" color="default">
        ...
        >
          ...
          <Tab label="Data Pribadi" {...a11yProps(1)} disabled />
      ...
      <TabPanel value={value} index={1}>
        <Formdatapribadi handleNext={handleChange} listdata= {listdata}></Formdatapribadi>
      </TabPanel>
      ...
      <TabPanel value={value} index={4}>
        <Formdatafinansial handleNext={handleChange} listdata= {listdata}></Formdatafinansial>
      </TabPanel>
     </Layout>
    </div>
  );
